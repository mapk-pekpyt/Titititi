...
DEFAULT_PRICE = 1       # Цена за 1 показ (в «звёздах» или валюте)
...
def handle_all(bot, message):
    ...
    if not data.get("pending"):
        ...
        for uid, ad in data["pending"].items():
...
# -------------------------
# Обработка обычного текста от пользователя
# -------------------------
